      ...
      <div className={cn(
        ...
        <div className="mt-4 flex justify-end gap-2 flex-wrap">
          <button
            onClick={onCancel}
            className={cn(
              "px-3 py-1.5 rounded-md text-xs font-medium pointer-coarse:min-h-[48px] pointer-coarse:px-4 pointer-coarse:text-sm transition-colors",
          ...
          <button
            onClick={onConfirm}
            className={cn(
              "px-3 py-1.5 rounded-md text-xs font-medium pointer-coarse:min-h-[48px] pointer-coarse:px-4 pointer-coarse:text-sm text-white transition-colors",
